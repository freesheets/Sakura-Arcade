...
export function EditGameModal({ visible, onClose, game }) {
  ...
  useEffect(() => {
    if (game && visible) {
      ...
      setMultiplayerType(game.multiplayerType || '');
    }
  }, [game, visible]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      AlertService.success('Sucesso!', 'Jogo atualizado com sucesso!');
      onClose();
    } catch (error) {
      AlertService.error('Erro', error.message || 'Erro ao atualizar jogo');
    } finally {
